		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-offset-1 col-md-6 col-xs-12">	
					<h1 class="center-block rs-headH1 text-center">河南易则鑫贸易有限公司</br>业务信息管理中心</h1>
				</div>
	 			<div class="col-md-5 col-xs-12">
	 			 	<div class="center-block rs-content">
						<h1 class="rs-fontColor text-center">登录</h1>
						<hr />
			 			<form class="form-horizontal container-fluid" action="User_login" method="post">
			 				<!--用户名--> 		
				 			<div class="form-group">
							    <span class="rs-fontColor col-xs-12" style="font-size:20px;">用户名：</span>
							    <div class="col-xs-10 col-xs-offset-1">
							        <input name="userName" type="text" class="form-control input-lg well" style="padding: 10px 16px;" id="exampleInputName1"placeholder="请输入账号" >
				 			...
				 			<div class="form-group">
							    ...
							    <div class="col-xs-10 col-xs-offset-1">
							    	<input name="password" type="password" class="  form-control input-lg well" style="padding: 10px 16px;" id="exampleInputPassword1" placeholder="请输入密码">
							...
							<div style="color: red;">${msg }</div>
				 			 ...
				 			 <!--<div class="form-group">	
				 				<div class="col-xs-12 col-xs-offset-1" >
									 ...
									 <img src="<c:url value='/web/image.jsp'/>" onclick=" location.reload()" id="checks" style="width: 100px;height: 30px;margin-left: 10px"/>
